...
async def generate_reading(data: UserInput):
    ...
    prompt = (
         ...
         f"4. A detailed month-by-month forecast for the next 3 months starting from {current_date}, covering Love, Career, and Personal Growth while going into a profound amount of accuracy and detail.\n"
